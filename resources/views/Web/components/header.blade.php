...
>
    <div class="team0001-container">
        ...
        >
            ...
            <button
                type="button"
                class="team0001-mobile-button"
                @click.stop="toggleMenu()"
                :aria-expanded="mobileOpen"
                aria-controls="team0001-mobile-menu"
        ...
        {{-- ================= MOBILE MENU ================= --}}
        <div
            id="team0001-mobile-menu"
            class="team0001-mobile-menu"
            x-show="mobileOpen"
            x-transition
...
.team0001-language button:hover {
    color: #fff;
}

.team0001-language button.active {
    color: var(--team-gold-light);
